		...
		<main className="page">
			...
			>
				<div className="exam-top">
					<button id="exam-start" type="button" className="primary" data-i18n="exam.start">Start exam</button>
					<p id="exam-timer" className="timer" role="timer" aria-label="Time remaining: 20:00">20:00</p>
				</div>
				<div id="exam-stage" hidden>
					...
					<button id="exam-next" type="button" className="primary" disabled data-i18n="exam.nextQuestion">Next question</button>
				</div>
